...
type Tag struct {
	...
	CatType    null.String `boil:"cat_type" json:"cat_type,omitempty" toml:"cat_type" yaml:"cat_type,omitempty"`
...
var TagWhere = struct {
	...
	CatType    whereHelpernull_String
	DeletedFLG whereHelperbool
}{
	ID:         whereHelperint{field: "`tags`.`id`"},
	Keyword:    whereHelpernull_String{field: "`tags`.`keyword`"},
	CatType:    whereHelpernull_String{field: "`tags`.`cat_type`"},
	DeletedFLG: whereHelperbool{field: "`tags`.`deleted_flg`"},
}
...
var (
	tagAllColumns            = []string{"id", "keyword", "cat_type", "deleted_flg"}
	tagColumnsWithoutDefault = []string{"keyword", "cat_type"}
	tagColumnsWithDefault    = []string{"id", "deleted_flg"}
