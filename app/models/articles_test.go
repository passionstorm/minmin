...
var (
	articleDBTypes = map[string]string{`ID`: `int`, `Title`: `varchar`, `Desc`: `varchar`, `Content`: `varchar`, `Position`: `int`, `HeadLine`: `varchar`, `Keywords`: `varchar`, `ImageThumb`: `varchar`, `ImageS`: `varchar`, `ImageM`: `varchar`, `ImageL`: `varchar`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`, `PublishedAt`: `datetime`}
	_              = bytes.MinRead
)
