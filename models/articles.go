...
type Article struct {
	...
	ImageThumb  null.String `boil:"image_thumb" json:"image_thumb,omitempty" toml:"image_thumb" yaml:"image_thumb,omitempty"`
...
var ArticleWhere = struct {
	...
	ImageThumb  whereHelpernull_String
	...
	ImageThumb:  whereHelpernull_String{field: "`articles`.`image_thumb`"},
...
var (
	articleAllColumns            = []string{"id", "title", "desc", "content", "position", "head_line", "keywords", "image_thumb", "image_s", "image_m", "image_l", "created_at", "updated_at", "published_at"}
	articleColumnsWithoutDefault = []string{"title", "desc", "content", "position", "head_line", "keywords", "image_thumb", "image_s", "image_m", "image_l", "created_at", "updated_at", "published_at"}
