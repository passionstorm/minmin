...
export const ROLE_EDITOR = 1;

export const CODE_MESSAGE = {
  200: 'Xử lý thành công.',
  201: 'Cập nhật dữ liệu thành công',
  202: 'Xử lý đang ở hàng đợi',
  204: 'Xoá dữ liệu thành công',
  400: 'Gặp lỗi khi xử lý!',
  401: 'Không có quyền',
  403: 'Được uỷ quyền. Nhưng truy cập bị cấm',
  404: 'Không tìm thấy dữ liệu',
  406: 'Loại yêu cầu chưa phát triển',
